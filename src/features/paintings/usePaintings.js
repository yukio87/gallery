...
export function usePaintings() {
    ...
    const { inputNameCurVal, selectAuthorIdCurVal, selectLocationIdCurVal, inputCreatedFromCurVal, inputCreatedBeforeCurVal, } = useSelector(getFilters);
    const filters = {
    ...
    const prefetchedNextPageFilters = Object.assign(Object.assign({}, params), { _page: currentPage + 1 });
    if (!isLoading && data) {
