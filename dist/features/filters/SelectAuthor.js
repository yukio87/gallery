...
function SelectAuthor() {
    ...
    function handleChange(name) {
        var _a;
        const authorId = (_a = authors === null || authors === void 0 ? void 0 : authors.find((authorObj) => authorObj.name === name)) === null || _a === void 0 ? void 0 : _a.id;
        if (authorId) {
    ...
    if (errorAuthors && errorAuthors instanceof Error)
        return React.createElement("span", null, errorAuthors.message);
    return (React.createElement("div", { className: styles.selectContainer },
        React.createElement(Select, { className: styles.selectAuthor, isDarkTheme: false, disabled: isLoading, options: authors, value: selectAuthorNameCurVal, onChange: name => handleChange(name) }),
        selectAuthorNameCurVal !== 'Author' ? (React.createElement(React.Fragment, null,
